    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors((cors) -> cors.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList("https://swit.kro.kr:15270"));
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        , "/api/place/**","/api/login_user", "/api/user/**", "/api/study/", "/api/study/**","/api/group/isLeader/","/api/group/**","/snslogin/**","/snslogin","/api/snslogin/*", "/login/info","ws/**","wss/**","/chat/**","api/chat/**", "/api/questions/","/api/answers","/api/refresh","/api/timer/*","/api/timer/**").permitAll()
