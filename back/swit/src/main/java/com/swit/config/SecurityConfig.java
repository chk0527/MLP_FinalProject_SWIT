    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/", "/api/join/**","/api/calendar/**", "/api/examjob/**", "/send_one"
                        , "/api/place/**", "/api/user/**", "/api/study/**","/api/group/isLeader/","/api/group/**","/snslogin/**", "/login/info","ws/**","/chat/**").permitAll()
