const ResultModal = ({title, content, callbackFn}) =>{
    return (
        ...
        onClick={()=>{
            ...
            <div className="absolute bg-white shadow dark:bg-gray-700 opacity-100 w-1/4 rounded mt-10 mb-10 px-6 min-w-[600]x">
                ...
                <div className="justfiy-end flex">
                    <button className="rounded bg-blue-500 mt-4 mb-4 px-6 pt-4 text-lg text-white"
                    onClick={()=>{
                        if(callbackFn){
                            callbackFn()
                        }
